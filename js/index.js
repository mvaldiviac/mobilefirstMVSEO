...
var abrirMenu = document.querySelector('#ham');
var abrirHambur = document.querySelector('#clickHam');
var cerrarHambur = document.querySelector('#closer');


abrirHambur.addEventListener('click', function(){

  if (cerrarHambur.checked){
